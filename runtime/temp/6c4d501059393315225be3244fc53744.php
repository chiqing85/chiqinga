<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"E:\www\bolg\chiqinga\chiqinga/app/admin\view\index\indexs.html";i:1515590812;}*/ ?>
...
<div class="row">
    ...
    <!--最新留言-->
    <div class="col-lg-3 col-sm-12 col-xs-12">
        <div class="small-box" style=" height: 31.3rem;">
            <div class="card-header-title">
                <i class="fa fa-comment" style="transform: rotateY(180deg);"></i>
                最新留言
            </div>
