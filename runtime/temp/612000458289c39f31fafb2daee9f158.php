<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"E:\www\bolg\chiqinga\chiqinga/app/admin\view\config\index.html";i:1515585119;}*/ ?>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <div class="col-sm-12 imgFile" style="padding-left: 0; margin-bottom: 4px;">
                        <input class="form-control" name="<?php echo $vo['key']; ?>" placeholder="网站Logo" value="<?php echo $vo['v']; ?>">
                        <i class="fa fa-picture-o imgFile-ico" style="padding-left: 5px;" onmouseover="mouseover()">
                            <div class="thumb">
                                <img >
                                <i></i>
                                <em></em>
                        ...
                        <span class="imgpicker">
            	 		...
            	 		<input type="file" class="file-invisible" name="image" accept="image/jpg,image/jpeg,image/png">
            	 	</span>
                    </div>
