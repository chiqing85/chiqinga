<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"E:\www\bolg\chiqinga\chiqinga\public/../app/admin\view\user\add.html";i:1517364860;}*/ ?>
<link rel="stylesheet" href="__Css__/config.css">
<div class="card-header-title">
    权限管理 > <a data-url="/Admin/User">管理员列表</a> >　添加用户
        ...
        <div class="box-content">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7 imgFile" style="margin-bottom: 4px;line-height: 1.4rem;">
                    <input class="form-control file-img" name="user_pic" placeholder="网站Logo" style="text-indent: 1.35rem;" value="">
                    ...
                    <span class="imgpicker">
                        ...
                        <input type="file" class="file-invisible file-user" name="image" accept="image/jpg,image/jpeg,image/png">
                    </span>
                </div>
            </div>
