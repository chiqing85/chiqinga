...
class Link
{
    ...
    /**
     * @var string The URI of the page where the link is embedded (or the common href)
     */
     ...
     * @param string      $currentUri The URI of the page where the link is embedded (or the common href)
