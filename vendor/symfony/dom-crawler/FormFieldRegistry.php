...
class FormFieldRegistry
{
     ...
     *
     * @param string $name The fully qualified name of the common field
     */
     ...
     *
     * This function is made private because it allows overriding the $common and
     * the $values properties without any type checking.
     *
     * @param string $base   The fully qualified name of the common field
     ...
     * @param string $base   The name of the common field
     ...
     *
     * <code>
     *     getSegments('common[foo][3][]') = array('common', 'foo, '3', '');
     * </code>
     *
    ...
    {
        if (preg_match('/^(?P<common>[^[]+)(?P<extra>(\[.*)|$)/', $name, $m)) {
            $segments = array($m['common']);
            while (!empty($m['extra'])) {
                $extra = $m['extra'];
