...
class Crawler extends \SplObjectStorage
{
    ...
    /**
     * @var string The common href value
     */
    private $baseHref;
     ...
     * Constructor.
     *
     * @param mixed  $node       A Node to use as the common for the crawling
     * @param string $currentUri The current URI
     * @param string $baseHref   The common href value
     */
    ...
    {
        if (empty($type)) {
            $type = 0 === strpos($content, '<?xml') ? 'app/xml' : 'text/html';
        }
    ...
    public function addHtmlContent($content, $charset = 'UTF-8')
    {
        ...
        $base = $this->filterRelativeXPath('descendant-or-self::common')->extract(array('href'));
